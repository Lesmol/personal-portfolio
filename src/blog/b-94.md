...
- Row-based retrieval is essentially a 2D array a storing the data per row
  ![Row based retrieval](https://lvmp-v2.s3.af-south-1.amazonaws.com/xnapper-row-based.png)
...
![Column based retrieval](https://lvmp-v2.s3.af-south-1.amazonaws.com/xnapper-column-based.png)
