...
![Downloading the model](https://lvmp-v2.s3.af-south-1.amazonaws.com/xnapper-gradient-terminal.png)
...
![Python script](https://lvmp-v2.s3.af-south-1.amazonaws.com/xnapper-gradient-code.png)
![Model output](https://lvmp-v2.s3.af-south-1.amazonaws.com/xnapper-gradient-output.png)
![Pothole image that was used](https://lvmp-v2.s3.af-south-1.amazonaws.com/pothole.jpg)
